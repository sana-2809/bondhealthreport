...
Automated Diagram Digitization leverages modern web technologies to create an intelligent flowchart recognition and editing platform. This chapter summarizes the key technologies, frameworks, and tools employed in the project. (Refer Table~\ref{tab:tech-stack}: Technology Stack Overview)
...
The development environment tools are summarised in (Refer Table~\ref{tab:dev-tools}: Development Environment Tools).
